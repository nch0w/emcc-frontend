...
async function competitorMail(emailAddress, teams, individuals) {
  await transporter.sendMail({
    ...
    The EMCC will be occurring on Saturday, February 20th. 
    <br /> <br />
    ...
    Furthermore, it is recommended for coaches and participants (and required for all proctors) to join the EMCC discord <a href="http://discord.com/invite/VeEAWdBtRR">here</a>, in order for us to communicate updates, announcements, and information quickly. Members of the Discord server can select a Coach, Proctor, and/or Participant role in the #roles channel. 
    <br /> <br />
    ...
    <b>Teams:</b> <br /> ${teams
      .map(
        (team) =>
          `${team.name}: ${team.student1} ${team.student2} ${team.student3} ${team.student4}`
      )
      .join("<br />")}
    <br />
    <br />
    <b>Individuals:</b> <br /> ${individuals
      .map((indiv) => indiv.student)
      .join("<br />")}
    <br /> 
    <br />
