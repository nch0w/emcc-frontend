...
// the EMCC server URL
export const emccServerUrl = 'http://localhost:8000'
...
export const ContactInfo = () => {
    ...
    return (
        <Grid container spacing={3}>
                ...
                <Card>
                    <CardContent>
                        <Typography variant='body1'>
                            Contact us by email at <Link to='mailto:exetermathclub@gmail.com'>exetermathclub@gmail.com</Link>!
                        </Typography>
                    </CardContent>
                </Card>
            </Grid>
            <Grid item xs={6}>
                <Card>
                    <CardMedia className={classes.media} image={require('./assets/placeholder1.png')} title='Sanath Govindarajan' />
                    <CardContent>
                        <Typography variant='body1'>
                            <b>Sanath Govindarajan</b>, Tournament Director
                            <br />
                            Email: <Link to='sgovindarajan@exeter.edu'>sgovindarajan@exeter.edu</Link>
                        </Typography>
                    </CardContent>
                </Card>
            </Grid>
            <Grid item xs={6}>
                <Card>
                    <CardMedia className={classes.media} image={require('./assets/placeholder2.png')} title='Benjamin Wright' />
                    <CardContent>
                        <Typography variant='body1'>
                ...
                <Card>
                    <CardContent>
                        <Typography variant='body1'>
                            ...
                            <br />
                            Email: <Link to='nchowdhury@exeter.edu'>nchowdhury@exeter.edu</Link>
                        </Typography>
                    </CardContent>
                </Card>
            </Grid>
                ...
                <Table>
                    ...
                    <TableBody>
                        ...
                        <TableRow>
                            ...
                            <TableCell colSpan={2}>
                                <Typography variant='body2'>
                                    Teams will be introduced to their proctors at registration.
                                    If teams arrive late for registration, they should go directly to the opening ceremony, in Assembly Hall.
                                </Typography>
                            </TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                            ...
                            <NoBorderTableCell>Assembly Hall (Academy Building)</NoBorderTableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell colSpan={2} />
                            <TableCell colSpan={2}>
                                <Typography variant='body2'>
                                    Proctors will lead teams after the opening ceremony directly to their classrooms for the individual rounds.
                                </Typography>
                            </TableCell>
                        </TableRow>
                        <TableRow>
                        ...
                        <TableRow>
                            ...
                            <TableCell colSpan={2}>
                                <Typography variant='body2'>
                                    Pizza will be available for free for students and coaches in the classrooms in which the students took the contest.
                                    Parents and other adults must bring their own lunch or buy lunch in town.
                                </Typography>
                            </TableCell>
                        </TableRow>
                        <TableRow>
...
export const RoundFormats = () => {
    ...
    let sweepstakesMaximumPoints = 4 * indivRoundsMaximumPoints + teamRoundsMaximumPoints;
    ...
    return (
        <Box>
            ...
            <Typography variant='body1'>
                ...
                The first part, the Speed Round, has {speedProblemCount} questions, each worth {speedProblemWeight} points, in {speedTimeLimit} minutes, emphasizing speed.
                The second part, the Accuracy Round, has {accuracyProblemCount} questions, each worth {accuracyProblemWeight} points, in {accuracyTimeLimit} minutes, emphasizing accuracy in problem solving.
            ...
            <Typography variant='body1'>
                ...
                The questions are given to the teams in sets of three.
                At the beginning of the round, each team will send a runner down to one of the scoring tables
                (spaced evenly throughout the contest hall to minimize differences in distance)
                to get the first set of three problems and bring it back to their team.
                The team then works together for as long as they need (within the 75 minute time limit) to solve these three problems.
                When they're ready, the runner drops off their answers at a scoring table, where they will receive the next set of three problems.
                At each scoring table, the problems will be scored as soon as they are dropped off,
                and a running tally of each team's points and progress will be displayed on a projector screen at the front of the hall.
            ...
            <Typography variant='body1'>
                ...
                Each of the {speedProblemCount} questions in the speed round is worth {speedProblemWeight} points,
                for a total of {speedMaximumPoints} points.
                Each of the {accuracyProblemCount} questions in the accuracy round is worth {accuracyProblemWeight} points,
                for a total of {accuracyMaximumPoints} points.
                In total, each individual can score up to {indivRoundsMaximumPoints} points.
                Each of the {teamProblemCount} questions in the team round is worth {teamProblemWeight} points,
                for a total of {teamMaximumPoints} points.
                Each of the {gutsProblemCount} questions in the guts round is weighted by set
                (in order, the weights are {gutsProblemWeightsStr}), for a total of {gutsMaximumPoints} points.
                Each team's sweepstakes score is calculated as the sum of the four individual scores
                (up to {4 * indivRoundsMaximumPoints} points)
                and the sum of the two team scores
                (up to {teamRoundsMaximumPoints} points),
                for a grand total of up to {sweepstakesMaximumPoints} points.
                <br /><br />
                In the case of a tie in any round, the tie will be broken as follows.
                <br /><br />
                Within a single round: The student or team who solved the last problem will be ranked higher.
                If the tie persists, the second last problem will be used, then the third last problem, and so on.
                A tie will not be broken in the case where two students or teams solved the exact same set of problems.
                <br /><br />
                Individual total: The student who has a higher total score of speed and accuray round will be ranked higher.
                If a tie persists, the student who ranked higher in the accuracy round will be ranked higher overall.
                If a tie persists, the student who ranked higher in the speed round will be ranked higher.
                <br /><br />
                Team sweepstakes: The team who has a higher total score of team and guts round will be ranked higher.
                If a tie persists, the team who ranked higher in guts round will be ranked higher.
                If a tie still persists, the team who ranked higher in team round will be ranked higher.
                <br /><br />
                No individual or team will be tie-broken out of the top 10.
                For example, in the case of a three-way tie for the 9th place individual,
                after tie-breaking there will be one person receiving 9th place and two receiving 10th place.
            </Typography>
        </Box>
    );
}